...
### About the Subgraph
This subgraph dynamically tracks **all the limit order transactions** (swaps) made via Paraswap on the **Arbitrum** chain. AugustusRFQ & AugustusRFQ-NFT swaps.

> You can query the subgraph via GraphQL from the legacy explorer [here](https://thegraph.com/hosted-service/subgraph/paraswap/augustus-rfq-subgraph-arbitrum).
